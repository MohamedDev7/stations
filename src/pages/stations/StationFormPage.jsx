...
import { addStation, getAllSubstances } from "../../api/serverApi";
							...
							{tanks.map((item) => (
								<TableRow key={item.id}>
									<TableCell>
										<Input
											required
											value={tanks.filter((el) => el.id === item.id)[0].number}
											onChange={(e) => {
												e.stopPropagation();
						...
						<TableBody>
							{dispensers.map((item) => (
								<TableRow key={item.id}>
									...
									<TableCell>
										<Input
											value={dispensers.filter((el) => el.id === item.id)[0].A}
											onChange={(e) => {
												e.stopPropagation();
												const updated = dispensers.map((el) => {
													if (el.id === item.id) {
									...
									<TableCell>
										<Input
											value={dispensers.filter((el) => el.id === item.id)[0].B}
											onChange={(e) => {
												e.stopPropagation();
												const updated = dispensers.map((el) => {
													if (el.id === item.id) {
						...
						<TableBody>
							{shifts.map((item) => (
								<TableRow key={item.id}>
									<TableCell>
										<Input
											value={shifts.filter((el) => el.id === item.id)[0].number}
											onChange={(e) => {
												e.stopPropagation();
									...
									<TableCell>
										<Input
											value={shifts.filter((el) => el.id === item.id)[0].start}
											onChange={(e) => {
												e.stopPropagation();
												const updated = shifts.map((el) => {
													if (el.id === item.id) {
